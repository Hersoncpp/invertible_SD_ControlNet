        ...
        for _, train_data in enumerate(train_loader):
            ...
            if current_step % opt['train']['val_freq'] == 0 and rank <= 0:
                ...
                for _, val_data in tqdm(enumerate(val_loader)):
                    ...
                    model.feed_data(val_data, identity=opt['identity'])
                    model.test(compress_flag=opt['compress_flag'])
                    ...
                    if current_step == opt['train']['val_freq']:
                        ...
                        save_img_path_gtl = os.path.join(img_dir, '{:s}_LR_ref_{:d}.jpg'.format(img_name, current_step))
